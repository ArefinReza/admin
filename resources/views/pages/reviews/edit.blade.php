        ...
        <div class="card-body">
            ...
            <form action="{{ route('reviews.update', $review->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img src="{{ asset('storage/' . $review->client_image) }}" alt="Client Image" class="img-thumbnail mt-2" width="100">
                </div>
                <div class="form-group">
                    <label for="feedback">Feedback</label>
                    <textarea class="form-control" id="feedback" name="feedback" rows="3" required>{{ $review->feedback }}</textarea>
                </div>
                <div class="form-group">
